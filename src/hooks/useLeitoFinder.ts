...
    );
    if (companheirosDeQuarto.length === 0) return 'Ambos';
...
            setor.leitos.map(leito => ({ ...leito, setorNome: setor.nomeSetor, setorId: setor.id!, divisaoPorQuarto: setor.divisaoPorQuarto }))
        );
...
        });
        ...
        // --- INÍCIO DA LÓGICA DE HOMÔNIMOS (APENAS ADICIONA DADOS, NÃO FILTRA) ---

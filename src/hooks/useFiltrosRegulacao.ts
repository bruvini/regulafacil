...
const aplicarOrdenacao = (pacientes: any[], sortConfig: { key: string; direction: string }) => {
...
export const useFiltrosRegulacao = (pacientes: any[]) => {
    ...
    const filteredPacientes = useMemo(() => {
        ...
        return aplicarOrdenacao(pacientesFiltrados, sortConfig);
    ...
    // Função para aplicar ordenação a listas específicas
    const aplicarOrdenacaoALista = (lista: any[]) => {
        return aplicarOrdenacao(lista, sortConfig);
    };
